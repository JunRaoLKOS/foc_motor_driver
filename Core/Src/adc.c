...
void My_DC_calib(void)
{
    ...
    HAL_Delay(800);
		...
		Iph_Calib.phA = get_adc_current(HAL_ADCEx_InjectedGetValue(&hadc1, 1));
		Iph_Calib.phB = get_adc_current(HAL_ADCEx_InjectedGetValue(&hadc2, 1));
